...
void DashboardWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (DashboardWindow::*)();
            if (_q_method_type _q_method = &DashboardWindow::navigateToDashboard; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (DashboardWindow::*)();
            if (_q_method_type _q_method = &DashboardWindow::navigateToCompress; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (DashboardWindow::*)();
            if (_q_method_type _q_method = &DashboardWindow::navigateToDecompress; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (DashboardWindow::*)();
            if (_q_method_type _q_method = &DashboardWindow::navigateToVisualizer; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _q_method_type = void (DashboardWindow::*)();
            if (_q_method_type _q_method = &DashboardWindow::navigateToHistory; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _q_method_type = void (DashboardWindow::*)();
            if (_q_method_type _q_method = &DashboardWindow::navigateToSelection; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            using _q_method_type = void (DashboardWindow::*)();
            if (_q_method_type _q_method = &DashboardWindow::navigateToAboutHelp; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
...
// SIGNAL 0
void DashboardWindow::navigateToDashboard()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void DashboardWindow::navigateToCompress()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void DashboardWindow::navigateToDecompress()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void DashboardWindow::navigateToVisualizer()
{
    QMetaObject::activate(this, &staticMetaObject, 3, nullptr);
}

// SIGNAL 4
void DashboardWindow::navigateToHistory()
{
    QMetaObject::activate(this, &staticMetaObject, 4, nullptr);
}

// SIGNAL 5
void DashboardWindow::navigateToSelection()
{
    QMetaObject::activate(this, &staticMetaObject, 5, nullptr);
}

// SIGNAL 6
void DashboardWindow::navigateToAboutHelp()
{
